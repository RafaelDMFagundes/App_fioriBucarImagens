		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#googleappimagens-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"googleappimagens-display": {
								"semanticObject": "googleappimagens",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=googleappimagens",
									"url": sap.ui.require.toUrl("googleappimagens")
								}
							}
						}
					}
